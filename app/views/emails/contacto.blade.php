                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style='text-align:left'>
                                                        ...
                                                        <p><b>Nombre:</b> {{ Input::get('n') }} </p>
                                                        <p><b>Email:</b>  {{ Input::get('e') }} </p>
                                                        <p><b>Mensaje:</b>  {{ Input::get('m') }} </p>
                                                        <p><a style='color:#3a6f8f;text-decoration:none;' href='http://www.reyesgroup.com' target='_blank'><span style='text-transform:uppercase;'></span><br>Reyes Group</a></p>
                                                    </td>
                                                    <td width='10'></td>
                                                </tr>
                                            </tbody>
